...
class NotificationHelper {
  ...
  static Future<void> initialize(FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      debugPrint("onMessage: ${message.notification!.title}/${message.notification!.title}/${message.notification!.body}");
      debugPrint("onMessage data:${message.data}");
      debugPrint("onMessage type:${message.data['type']}");
...
Future<dynamic> myBackgroundMessageHandler(RemoteMessage message) async {
  ...
  if (data['type'] == 'new_order' || data['type'] == 'New order placed') {
